    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-[#5b6480]">{ticket.category}</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          {ticket.agent && (
            <div>
              <h3 className="font-bold text-[#001353] mb-2">Assigned Agent</h3>
              <p className="text-[#5b6480]">{ticket.agent.fullName}</p>
              <p className="text-sm text-[#5b6480]">{ticket.agent.email}</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
        <h3 className="font-bold text-[#001353] mb-4">Conversation</h3>
