...
export const metadata: Metadata = {
  ...generateMeta({
    title: "Privacy Policy – Shifty",
    description: "Shifty's privacy policy. Learn how we collect, use and protect your personal data.",
    path: "/privacy",
    noIndex: false,
  }),
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray max-w-none">
          <div className="space-y-10 text-[#1b1d21]">
            {[
              ...
              { title: "6. Your Rights", body: "You have the right to access, correct, or delete your personal data at any time. You can export your data or close your account from the app settings. For requests, contact privacy@shifty.com." },
              ...
              { title: "8. Contact", body: "For privacy concerns, email privacy@shifty.com or write to: Shifty Data Protection Officer, 45 Gulshan Avenue, Dhaka 1212, Bangladesh." },
            ].map((section) => (
